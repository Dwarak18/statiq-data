    ...
    series: [
      {
        ...
        areaStyle: {
          color: {
            ...
            colorStops: [{ offset: 0, color: 'rgba(185, 104, 78, 0.3)' }, { offset: 1, color: 'rgba(185, 104, 78, 0)' }]
          }
        }
      }
    ]
              ...
              <ReactECharts
                option={{
                  ...
                  series: [
                    ...
                    { name: 'Peer Median', type: 'line', smooth: true, data: [90, 120, 170, 230, 310, 390], itemStyle: { color: '#657B6C' } },
