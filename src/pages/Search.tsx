      ...
      <div className="border-b border-border bg-surface px-4 py-12 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-8">
            <h1 className="text-4xl font-bold font-heading mb-4">Ask anything.</h1>
            <p className="text-text-muted text-lg">Use natural language to query 5M+ datasets, reports, and company profiles.</p>
          </div>
