...
export function Workspace() {
  ...
  const chartOption1 = {
    ...
    series: [
      { type: 'bar', data: [12, 19, 15, 22], itemStyle: { color: '#B9684E' } }
    ]
  };
    ...
    series: [
      {
        ...
        radius: ['50%', '80%'],
        data: [
          { value: 1048, name: 'Tech', itemStyle: { color: '#B9684E' } },
          { value: 735, name: 'Health', itemStyle: { color: '#657B6C' } },
          { value: 580, name: 'Fin', itemStyle: { color: '#996B4A' } },
        ]
      }
    ]
  };
